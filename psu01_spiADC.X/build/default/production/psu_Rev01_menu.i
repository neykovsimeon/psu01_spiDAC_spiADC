...
# 2008 "../../pic18_plib/include/plib\adc.h"
union ADCResult
{
int lr;
char br[2];
...
# 584 "../../pic18_plib/include/plib\spi.h"
...
lastStateROTARY_CK = PORTBbits.RB7;
...
for (int i = 0; i < 200; i++) {
lastStateROTARY_CK = PORTBbits.RB7;
_delay((unsigned long)((0.1)*(8000000/4000.0)));
currentStateROTARY_CK = PORTBbits.RB7;
...
if (PORTBbits.RB7 == PORTAbits.RA4) {
rotary_direction = 0;
} else {
rotary_direction = 1;
}
