...
# 39
LCDWriteStringROM(6, 0, ResultString_u, 1, ' ');
...
LCDWriteStringROM(6, 2, ResultString_set_i, 1, ' ');
}
...
voltage_set_u = ((DAC_u*DAC_vRef)/4096)*6;
...
voltage_set_i = (DAC_i*DAC_vRef)/4096;
sprintf(ResultString_set_i, "%-.3f", voltage_set_i);
SetDDRamAddr (0x00);
putrsXLCD("Iprot=");
