...
# 26 "../../pic18_plib/include/plib\htc.h"
extern const char __xc8_OPTIM_SPEED;

extern double __fpnormalize(double);

# 52 "C:\Program Files (x86)\Microchip\xc8\v2.00\pic\include\pic18f2525.h"
...
# 13 "../../pic18_plib/include/plib\delays.h"
...
# 23 "psu_Rev01_hardware.h"
void init_GPIO_DIR (void);

# 11 "display_functions.h"
...
const char menu_001[] = "Set Output";
const char menu_002[] = "Set Display";
const char menu_003[] = "Exit";

const char menu_010[] = "<Set Output>";
const char menu_011[] = "Set U out ";
const char menu_012[] = "Set I mode";
const char menu_013[] = "Set I set ";
const char menu_014[] = "Out preset";
const char menu_015[] = "Return";

const char menu_020[] = "<Set I mode>";
const char menu_021[] = "Limit Mode";
const char menu_022[] = "Prot. Mode";
const char menu_023[] = "Auto Mode";
const char menu_024[] = "Return";


const char menu_030[] = "<Set Display>";
const char menu_031[] = "Set Contrast";
const char menu_032[] = "Set Backlight";
const char menu_033[] = "Preset";
const char menu_034[] = "Return";
...
{menu_001, 4, 1, 2, 5, 0},
{menu_002, 4, 1, 3, 16, 0},
{menu_003, 4, 2, 3, 1, return_to_default},

{menu_010, 6, 0, 0, 0, 0},
{menu_011, 6, 5, 6, 5, setUout},
{menu_012, 6, 5, 7, 11, 0},
{menu_013, 6, 6, 8, 7, setIset},
{menu_014, 6, 7, 9, 8, outPreset},
{menu_015, 6, 8, 9, 1, 0},

{menu_020, 5, 0, 0, 0, 0},
{menu_021, 5, 11, 12, 5, setImode_limit},
{menu_022, 5, 11, 13, 5, setImode_prot},
{menu_023, 5, 12, 14, 5, setImode_auto},
{menu_024, 5, 13, 14, 5, 0},

{menu_030, 5, 0, 0, 0, 0},
{menu_031, 5, 16, 17, 16, setContrast},
{menu_032, 5, 16, 18, 17, setBacklight},
{menu_033, 5, 17, 19, 18, displayPreset},
{menu_034, 5, 18, 19, 1, 0},
};


void LCDWriteCmd (unsigned char command) {
while(BusyXLCD());
WriteCmdXLCD(command);
}
...
if (x_pos > (16 - 1)) x_pos = 0;
if (y_pos > (4 - 1)) y_pos = 0;
switch ( y_pos ) {
case 0: {
...
case 2: {
ddramaddress = (0x10 + x_pos);
break;
}
case 3: {
ddramaddress = (0x50 + x_pos);
break;
}
default: {
ddramaddress = (0x00 + x_pos);
...
if (lcd_offset > 16) lcd_offset = 16;
for (lcd_i = lcd_offset; lcd_i; lcd_i--){
while(BusyXLCD());
WriteDataXLCD(*lcd_menu_items);
lcd_menu_items++;
}
if (add_line){
for (lcd_i = 16 - lcd_offset - x; lcd_i; lcd_i--) {
while(BusyXLCD());
WriteDataXLCD(add_char);
}
}
