...
ADCResult /= 10;
voltage_u = 0;
voltage_u = (((ADCResult*ADC_vRef)/4096) + raw_adc_offset_voltage)*6;
...
ADCResult /= 10;
voltage_i = 0;
voltage_i = raw_adc_offset_voltage + ((ADCResult*ADC_vRef)/4096);
