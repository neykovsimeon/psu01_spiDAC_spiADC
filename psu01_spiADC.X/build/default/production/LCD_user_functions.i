...
void Delay1Sec(void){
for (int cntDelay = 0; cntDelay < 20; cntDelay ++) _delay((unsigned long)((50)*(8000000/4000.0)));
}

void DelayHalfSec(void){
for (int cntDelay = 0; cntDelay < 10; cntDelay ++) _delay((unsigned long)((50)*(8000000/4000.0)));
}

void Delay200ms(void){
for (int cntDelay = 0; cntDelay < 10; cntDelay ++) _delay((unsigned long)((20)*(8000000/4000.0)));
}
